...
public class LexicalChain {
   ...
   public static void main(String args[]) {
      try {
         if (args.length > 1) {
            LexicalChain lc = new LexicalChain(args[0]);
         ...
         System.out.println("Usage: java LexicalChain <filename>");
      }
   }
   ...
   **********************************************************************/
    ...
    ********************************************************************/
    private void calculateHeadDistribution(TreeMap<Integer, TreeSet<String>> headDistri, String word) {
       Integer headNo;
