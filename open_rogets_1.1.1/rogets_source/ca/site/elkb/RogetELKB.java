...
public class RogetELKB {
	...
	/***************************************************************************
	 * Location of the Semantic Relationships text file.
	 **************************************************************************/
	public static final String RELATIONS = "/relations.txt";
	...
	public RogetELKB(int year) {
		...
		try {
			...
			ObjectInputStream in = new ObjectInputStream(new FileInputStream(PATH_ELKB + INDEX));
		...
		// 4. load the relationships none at this time
		//System.err.println("Loading the Relationships...");
		//relations = new Relationships(PATH_ELKB + RELATIONS);
	}
	...
	/***************************************************************************
	 * This is Vivi's addition to help compute distances for the analogy problem
	 * 
	 * Returns all the paths between two words or phrases of a given
