...
public class SG {
	...
	public void addWord(String word, String tag) {
		...
		/*
		 * if ( pos.equals("N.") ) { writeToFile(word, "wordLists/rogetN.txt"); }
		 * else if ( pos.equals("ADJ.") ) { writeToFile(word,
		 * "wordLists/rogetADJ.txt"); } else if ( pos.equals("VB.") ) {
		 * writeToFile(word, "wordLists/rogetVB.txt"); } else if (
		 * pos.equals("ADV.") ) { writeToFile(word, "wordLists/rogetADV.txt"); }
		 * else if ( pos.equals("INT.") ) { writeToFile(word,
		 * "wordLists/rogetINT.txt"); } else { writeToFile(word,
		 * "wordLists/error.txt"); }
		 */
	}
