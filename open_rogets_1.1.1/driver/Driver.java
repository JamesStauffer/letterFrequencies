...
class Driver {
	...
	public static void main(String args[]) {
		System.out.println("#==================#");
		System.out.println("# ELKB Driver v2.0 #");
		System.out.println("#==================#\n");
		...
		try {
			while (i != 20) {
				...
				switch (i) {
				case 1:
					elkbDriver.createIndex(1987);
					break;
				case 2:
					elkbDriver.createIndex(1911);
					break;
				/*
	...
	private void printMenu() {
		System.out.println("\n         M E N U\n");
		System.out.println("1.  Create Roget's Index: 1987");
		System.out.println("2.  Create Roget's Index: 1911");
		/*
	 ...
	 * createIndex()
	 **************************************************************************/
	private void createIndex(int year) {
		...
		if (year == 1987) {
			elkbIndex = new Index(PATH_1987 + INDEX_FILE, 125000);
		} else if (year == 1911) {
			elkbIndex = new Index(PATH_1911 + INDEX_FILE, 75000);
		}
		long stop = System.currentTimeMillis();
		Runtime.getRuntime().gc();
